...
// Move the main component logic to a child component that can use useSearchParams
        ...
        handler: async function (response) {
          try {
            ...
            if (verifyResponse.ok) {
              ...
              router.push(
                `/payments/success?payment_id=${response.razorpay_payment_id}`
              );
            } else {
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="px-6 py-8 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-center">
            ...
            <p className="text-purple-100">
              You're one step away from transforming your wellness journey
            </p>
          </div>
...
// Main export default component with Suspense
